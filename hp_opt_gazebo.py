...
def objective(trial):
    ...
    env = env_factory.createEnv("loader", "big_S", True)
    ...
    result = num_finishes + highest*0.1
...
if __name__ == "__main__":
    ...
    study = optuna.load_study(study_name=STUDY_NAME, storage="sqlite:///./saves/hp_opt/optuna_hp.db")
