...
class KartSim(gym.Env):
    ...
    def draw_angles(self, screen):
        ...
        pygame.draw.line(self._background, pygame.Color(0, 0, 255, 100), player_position, (target_x, target_y), 2)
        ...
        pygame.draw.line(self._background, pygame.Color(0, 255, 0, 100), player_position, (player_x, player_y), 2)
    ...
    def render(self, mode):
        ...
        self._background.fill((0, 0, 0, 255))
