...
class KartSim(gym.Env):
    ...
    def step(self, action: Union[np.ndarray, int]):
        ...
        x = self.input_velocity * math.cos(self._playerBody.angle - ANGLE_DIFF)
        y = self.input_velocity * math.sin(self._playerBody.angle - ANGLE_DIFF)

        self._playerBody.angular_velocity = self.input_angle * self.player_rad_velocity
